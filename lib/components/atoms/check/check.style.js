...
exports.default = (0, react_jss_1.createUseStyles)(function (theme) {
    return ({
        ...
        checkbox: {
            ...
            overflow: 'hidden',
            boxShadow: "0 0 0 0 ".concat(theme.indigoPastel2),
            ...
            '&[data-has-focus=true]': {
                boxShadow: "0 0 0 ".concat(constant_1.FOCUS_OUTLINE_WIDTH, "px ").concat(theme.indigoPastel2),
            },
...
//# sourceMappingURL=check.style.js.map